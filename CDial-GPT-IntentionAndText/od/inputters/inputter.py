...
if __name__=="__main__":
    class config():
        import logging
        data_path = "/path/intention_text_CDial-GPT.json"
        dataset_cache = "dataset_cache"
        model_checkpoint="/home/jovyan/work/VRBot-History2/GPT2-Chinese/gpt2-chinese-youlai/final_model"
    ...
    tokenizer = tokenizer_class.from_pretrained(args.model_checkpoint, do_lower_case=True, never_split=["[speaker1]", "[intent]","[speaker2]"])
    datasets, raw_samples = get_data(tokenizer, args.data_path, args.dataset_cache, logger)
    train_dataset, valid_dataset = WBDataset(datasets["train"], tokenizer), WBDataset(datasets["valid"], tokenizer)
